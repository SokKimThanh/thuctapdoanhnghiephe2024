...
<?php if ($type == 'video-fotorama') {
	...
	// Một khi đã có dữ liệu video (count($videonb) > 0), thẻ <div> với id 
	// fotorama-videos sẽ được tạo.
	// Các thẻ <a> được thêm vào trong thẻ <div> để tạo slideshow video với Fotorama.
	if (count($videonb)) { ?>
		<!-- Video Fotorama -->
		<div id="fotorama-videos" data-width="100%" data-thumbmargin="5" data-height="360" data-fit="cover" data-thumbwidth="100" data-thumbheight="85" data-allowfullscreen="false" data-nav="thumbs">
			<!-- 
				Duyệt qua từng phần tử trong mảng $videonb để tạo các thẻ <a>
				cho từng video.
				Hàm $func->getYoutube($videonb[$i]['link_video']) được sử dụng 
				để lấy mã video từ URL của YouTube.
			-->
		...
		<script type="text/javascript">
			// Hàm $("#fotorama-videos").fotorama(); được gọi khi tài liệu đã
			// sẵn sàng để khởi tạo slideshow Fotorama cho các video được hiển thị.
